    ...
    public function getTablesCreateSql()
    {
        ...
        $tables = array(
            ...
            'log_visit' => "CREATE TABLE {$prefixTables}log_visit (
                              ...
                              visitor_count_visits INTEGER NOT NULL,
                              visitor_days_since_last INTEGER NOT NULL,
                              visitor_days_since_order INTEGER NOT NULL,
                              visitor_days_since_first INTEGER NOT NULL,
                              ...
                              visit_total_actions INTEGER NOT NULL,
                              visit_total_searches INTEGER NOT NULL,
                              visit_total_events INTEGER NOT NULL,
                              visit_total_time INTEGER NOT NULL,
            ...
            'log_link_visit_action' => "CREATE TABLE {$prefixTables}log_link_visit_action (
                                              idlink_va SERIAL8 NOT NULL,
                                              idsite BIGINT NOT NULL,
                                              idvisitor BYTEA NOT NULL,
                                              server_time TIMESTAMP NOT NULL,
                                              idvisit BIGINT NOT NULL,
                                              idaction_url BIGINT DEFAULT NULL,
                                              idaction_url_ref BIGINT DEFAULT 0,
